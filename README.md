...
The fastest way is the live link above. To run locally, clone the repo and open `index.html` in any modern browser — no build, no dependencies, one self-contained HTML file.
